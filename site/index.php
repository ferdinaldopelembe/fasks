...
<head>
  ...
  <style>
    ...
    * {
    ...
    .create-task-form form input, button, textarea{
    ...
    .create-task-form form input:focus-within, textarea:focus-within {
...
<body>
  <header>
    ...
    <div title= <?php echo $username ?> class="user">
  ...
  <main>
    <section id="cards-container" class="cards-container">
      <div class="card blue">
        <div class="information">
          ...
          <span>você tem um total de <span class="total_tasks">0</span> tarefas</span>
        </div>
      ...
      <div class="card orange">
        <div class="information">
          ...
          <span>você tem <span class="undone_tasks">0</span> tarefas pendentes</span>
        </div>
    ...
    <section class="tasks">
      ...
      <button id="create-task" title="Adicionar Tarefa" class="create-task"><i class="fa-solid fa-add"></i></button>
    </section>
    ...
    <div id="create-task-form" class="create-task-form">
      <form id="create-form" method="POST">
        ...
        <input id="task-name" placeholder="sua tarefa..." name="task_name" type="text" required>
        <label for="task_description">Descrição da tarefa</label>
        <textarea id="task-description" placeholder="Descreva o que vai fazer..." rows="10" name="task_description" required></textarea>
        <div class="actions">
          <button id="cancel-create-button">cancelar</button>
          <button type="submit" id="submit-task" value="adicionar" title="adicionar">adicionar</button>
        </div>
      </form>
    </div>
  ...
  <script>
    ...
    document.getElementById('create-form').onsubmit = (async ()=>{
      ...
      fetch(`api/create_task.php?task_name=${task_name}&task_description=${task_description}`);
      taskFormContainer.style.display = 'none';
    })
